...
def set_engine_geometry(engine):
    ...
    engine.ox_orifice_number = 10
    engine.ox_orifice_diameter = 0.001*2

    engine.ox_feed_model = 0

    engine.fuel_orifice_number = 0

    engine.charge_length = 0.6
    ...
    engine.nozzle_area_ratio = 2
    engine.nozzle_throat_diameter = 0.03*2
...
print('Simulating HDPE...')
hdpe_res, hdpe_total_impulse, total_thrust = simulate(engine, MAX_ITERATIONS)
...
plt.savefig('./output/r2s_2026/propcompare2.png', bbox_inches='tight')